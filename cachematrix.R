...
### it returns the cached value. In case there isn't, it calculates the inverse and returns it. This function assumes
### that the provided matrix is always invertible.
